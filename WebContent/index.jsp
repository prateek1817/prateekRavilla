...
<%--
    Licensed to the Apache Software Foundation (ASF) under one or more"WebContent/index.jsp"
    ...
    See the License for the specific language governing permissions and"WebContent/WEB-INF/struts-config-Wildcard.xml"
